...
var STRINGS = {
  en: {
    ...
    entryFeeLabel: 'Entry fee in coins (optional — charged to every seated player)',
    entryFeePlaceholder: 'e.g. 50, or leave blank for free',
  ...
  fa: {
    ...
    entryFeeLabel: 'ورودی بازی به سکه (اختیاری — از همه بازیکنان نشسته کسر می‌شود)',
    entryFeePlaceholder: 'مثلاً ۵۰، یا برای رایگان خالی بگذارید',
